...
description: Intelligent vector compression for Pinecone
---
...
Ready to compress your vector database? Follow the [Installation Guide](./getting-started/installation.md) to get started.
